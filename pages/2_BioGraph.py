...
min_day = today - relativedelta(years=80)
default_birthday = today - relativedelta(years=25)

birth_date = st.date_input(
    "Enter your birth date",
    help="YYYY-MM-DD 형식으로 입력해주세요.",
...
plt.axvline(today, color="blue", linestyle="--", label="Target Day")
plt.title("Biorhythm")
plt.xlabel("Date")
